...
message(STATUS "planning: 2 messages, 0 services")

set(MSG_I_FLAGS "-Iplanning:/root/catkin_ws/src/planning/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/root/catkin_ws/src/planning/msg/LTP_Plan.msg" NAME_WE)
add_custom_target(_planning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planning" "/root/catkin_ws/src/planning/msg/LTP_Plan.msg" ""
)

get_filename_component(_filename "/root/catkin_ws/src/planning/msg/STP_Data.msg" NAME_WE)
add_custom_target(_planning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planning" "/root/catkin_ws/src/planning/msg/STP_Data.msg" ""
)
...
_generate_msg_cpp(planning
  "/root/catkin_ws/src/planning/msg/LTP_Plan.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/planning
)
_generate_msg_cpp(planning
  "/root/catkin_ws/src/planning/msg/STP_Data.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/planning
)
